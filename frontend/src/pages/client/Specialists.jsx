...
export default function Specialists() {
  ...
  useEffect(() => { if (cancelled) { const timer = setTimeout(() => setCancelled(false), 3000); return () => clearTimeout(timer); } }, [cancelled]);
